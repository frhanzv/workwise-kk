...
<div class="flex flex-col gap-6">
    <div class="flex items-center gap-4 mt-6 md:mt-4">
        <a href="<?= base_url('products/view/' . $product['id']) ?>" class="p-2 text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
            <span class="material-symbols-outlined text-2xl">arrow_back</span>
        </a>
        <div>
            <h1 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Edit Product</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400"><?= esc($product['product_code']) ?> — <?= esc($product['product_name']) ?></p>
        </div>
    </div>
